                ...
                child: Column(children: [
                    ...
                    SingleChildScrollView(
                      ...
                      children: shareItem.map((item) => GestureDetector(
                        onTap: () => Share.share('Greetings, OZCANSHOPPING is the best e-commerce platform in the country. If you are new to this website don’t forget to use "${Provider.of<ProfileProvider>(context, listen: false).userInfoModel?.referCode??''}" as the referral code while sign up into OzcanShopping. ${'${Provider.of<SplashProvider>(context, listen: false).configModel?.refSignup}${Provider.of<ProfileProvider>(context, listen: false).userInfoModel?.referCode??''}'}',),
